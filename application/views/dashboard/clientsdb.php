...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Add Client's Informations</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div>
                    <?php echo form_open_multipart('Dashboard/save_clients'); ?>
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <input type="text" name="client_name" class="form-control" placeholder="Client's name" value="<?php echo  @$edit_id->client_name ?>">
                      </div>
                      <div class="col">
                        <strong>Client's Company:</strong>
                        <input type="text" name="client_company" class="form-control" placeholder="Client's company name" value="<?php echo  @$edit_id->client_company ?>">
                      </div>
                    </div>

                    <div class="row mt-3">
                      <div class="col">
                        <strong>Client's Opinion:</strong>
                        <textarea name="client_opinion" id="opinion" cols="10" rows="1" cked placeholder="Give your opinion here.."><?php echo  @$edit_id->client_opinion ?></textarea>
                      </div>
                    </div>

                    <div class="row mt-2">
                      <div class="col">
                        <strong>Client's Photo:</strong>
                        <input type="file" name="client_photo" class="form-control" value="<?php echo  @$edit_id->client_photo ?>">
                      </div>
                      <div class="col">
                        <strong>.</strong>
                        ...
                        <tbody>
                          ...
                          foreach ($clients_info as $client) { ?>
                            <tr>
                              ...
                              <td><?php echo $client->client_company ?></td>
                              <td><?php echo $client->client_opinion ?></td>
                              <!-- <td><?php //echo $client->client_photo 
                                        ?></td> -->
                              <td><img height="30" width="40" alt="Image not found" src="<?php echo base_url('/uploads/' . $client->client_photo) ?> "></td>
                              <td>
                                <a href="<?php echo base_url('Dashboard/clients/' . $client->id) ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                                <a href="<?php echo base_url('Dashboard/delete_client_info/' . $client->id) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                              </td>
                            </tr>
                          <?php } ?>
                        </tbody>
    ...
    <!-- CKeditor cdn/code which used for textarea field -->
