    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <!-- <h1 class="text-center">Client's All Message</h1> -->
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h1 class="text-center mb-3">Client's All Message</h1>
                  <table class="table table-bordered text-center">
                    ...
                    <tbody>
                      <?php $sl = 0;
                      foreach ($cont_msg as $cmg) { ?>
                        <tr>
                          <td><?php echo ++$sl; ?></td>
                          <td><?php echo $cmg->name; ?></td>
                          <td><?php echo $cmg->email; ?></td>
                          <td><?php echo $cmg->subject; ?></td>
                          <td><?php echo $cmg->message; ?></td>
                          <td>
                            <a href="<?php echo base_url('Dashboard/delete_cont_msg/' . $cmg->id) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
