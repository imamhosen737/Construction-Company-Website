						...
						<div class="col-md-12">
							<div class="card">
								...
								<h1>Update about section</h1>
									...
									<?php echo form_open('Dashboard/update_about_info/' . $edit->id); ?>
									<div class="row">

										<div class="col">
											<strong>Welcome</strong>
											<input type="text" name="welcome_to" class="form-control" value="<?php echo $edit->welcome_to ?>">
										</div>
										<div class="col">
											<strong>Welcome Heading</strong>
											<input type="text" name="welcome_heading" class="form-control" value="<?php echo $edit->welcome_heading ?>">
										</div>
									</div>
									...
									<div class="row mt-3">
										<div class="col">
											...
											<textarea name="description" id="description" cols="10" rows="1" cked><?php echo  $edit->description ?></textarea>
										</div>
									</div>
									...
									<div class="row mt-3">
										<div class="col">
											...
											<textarea name="description2" id="descriptions" cols="10" rows="1" cked><?php echo  $edit->description2 ?></textarea>
										</div>
									</div>
									...
									<div class="row">
										<div class="col">
											...
											<input type="text" name="total_employee" class="form-control" value="<?php echo $edit->total_employee ?>">
										</div>
										<div class="col">
											<strong>Total Clients</strong>
											<input type="text" name="total_clients" class="form-control" value="<?php echo $edit->total_clients ?>">
										</div>
									</div>
									...
									<div class="row">
										<div class="col">
											...
											<input type="text" name="complete_project" class="form-control" value="<?php echo $edit->complete_project ?>">
										</div>
										<div class="col">
											<strong>Running Project</strong>
											<input type="text" name="running_project" class="form-control" value="<?php echo $edit->running_project ?>">
										</div>
									</div>
