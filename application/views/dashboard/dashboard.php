  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <!-- Navbar Search -->
        <li class="nav-item">
          <a href="<?php echo base_url('Dashboard/logout') ?>" class="btn btn-sm text-white btn-warning">Logout</a>
        </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <?php echo "<h1> Welcome " . $this->session->userdata('name') . "</h1>" ?>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="mb-5">
                    ...
                    <?php echo form_open('Dashboard/add_admin/' . @$edit_id->id) ?>


                    <div class="row">
                      <div class="col">
                        <strong>Name:</strong>
                        <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo  @$edit_id->name ?>">
                      </div>
                      <div class="col">
                        <strong>Username:</strong>
                        <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo  @$edit_id->username ?>">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="text" name="password" class="form-control" placeholder="Password" value="<?php echo  @$edit_id->password ?>">
                      </div>
                      <div class="col">
                        <strong>&nbsp;</strong>
                    ...
                    <tbody>
                      ...
                      foreach ($list as $l) { ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url('Dashboard/edit_admin/' . $l->id) ?>" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>
                            <a href="<?php echo base_url('Dashboard/delete_admin/' . $l->id) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
