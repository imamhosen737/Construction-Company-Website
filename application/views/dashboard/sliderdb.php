...
<head>
  ...
  <title><?php if(isset($page)) {echo $page." | agency "; } else { echo "agency";} ?></title>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <h1>Add New Slider</h1>
            ...
            <?php echo form_open_multipart('Dashboard/save_slider'); ?>
		     <div class="row">
         ...
         <?php } ?>
           ...
           <div class="col">
			   <strong>Top Heading</strong>
          <input type="text" name="top_headline"  class="form-control" placeholder="Top Heading" value="<?php echo @$edit_id->top_headline ?>">
          </div>
          <div class="col">
		     <strong>Main Heading</strong>
         <input type="text" name="main_headline"  class="form-control" placeholder="Main Heading" value="<?php echo @$edit_id->main_headline ?>">
        </div>
        </div>
	   ...
	   <div class="row mt-2">
          <div class="col">
		  <strong>Photo:</strong>
         <input type="file" name="slider_photo" class="form-control" value="<?php echo @$edit_id->slider_photo ?>">
        </div>
		<div class="col">
			<strong>.</strong>
		<input type="submit" class="btn btn-block btn-success">
          ...
          <div class="containr mt-5">
			  ...
			  <table class="table table-bordered text-center">
				  ...
				  <tbody>
					   <?php $sl = 0; foreach($slider_info as $s){ ?>
					  <tr>
						  <td><?php echo ++$sl; ?></td>
						  <td><?php echo $s->top_headline ?></td>
						  <td><?php echo $s->main_headline ?></td>
              <td><img height="30" width="40" alt="Image not found" src="<?php echo base_url('/uploads/'.$s->slider_photo)?> "></td>
						  <td>
							  <a href="<?php echo base_url('Dashboard/slider/'.$s->id) ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
							  <a href="<?php echo base_url('Dashboard/delete_slider_info/'.$s->id) ?>"class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
						  </td>
					  </tr>
					  <?php } ?>
				  </tbody>
