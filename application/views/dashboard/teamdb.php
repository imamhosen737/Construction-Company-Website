            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <?php echo form_open_multipart('Dashboard/save_team'); ?>
                  <div class="row">
                    ...
                    <div class="col">
                      <strong>Name:</strong>
                      <input type="text" name="name" class="form-control" placeholder="Team Member's Name" value="<?php echo  @$edit_id->name ?>">
                    </div>
                    <div class="col">
                      <strong>Designation:</strong>
                      <input type="text" name="designation" class="form-control" placeholder="Designation" value="<?php echo  @$edit_id->designation ?>">
                    </div>
                  </div>
                  ...
                  <div class="row mt-2">
                    <div class="col">
                      <strong> Photo:</strong>
                      <input type="file" name="photo_team_member" class="form-control" value="<?php echo  @$edit_id->photo_team_member ?>">
                    </div>
                    <div class="col">
                      <strong>Twitter Link:</strong>
                      <input type="text" name="tw" class="form-control" placeholder="Twitter Link" value="<?php echo  @$edit_id->tw ?>">
                    </div>
                  </div>
                  ...
                  <div class="row mt-2">
                    <div class="col">
                      ...
                      <input type="text" name="fb" class="form-control" placeholder="Facebook Link" value="<?php echo  @$edit_id->fb ?>">
                    </div>

                    <div class="col">
                      <strong>Linkedin Link:</strong>
                      <input type="text" name="lindin" class="form-control" placeholder="Linkedin Link" value="<?php echo  @$edit_id->lindin ?>">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <input type="text" name="insta" class="form-control" placeholder="Instagram Link" value="<?php echo  @$edit_id->insta ?>">
                    </div>
                    <div class="col">
                      <strong>.</strong>
                ...
                <tbody>
                  ...
                  foreach ($team_info as $team) { ?>
                    <tr>
                      ...
                      <td><?php echo $team->tw ?></td>
                      <td><?php echo $team->fb ?></td>
                      <td><?php echo $team->lindin ?></td>
                      <td><?php echo $team->insta ?></td>
                      <td>
                        <a href="<?php echo base_url('Dashboard/team/' . $team->id) ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                        <a href="<?php echo base_url('Dashboard/delete_team_info/' . $team->id) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
