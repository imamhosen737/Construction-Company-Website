						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="mb-3">Update about section</h1>
									...
									<table class="table table-bordered text-center">
										...
										<tbody>
											<?php foreach ($about_info as $about) { ?>
												<tr>
													<td><?php echo $about->welcome_to ?></td>
													<td><?php echo $about->welcome_heading ?></td>
													<td><?php echo $about->description ?></td>
													<td><?php echo $about->description2 ?></td>
													<td><?php echo $about->total_employee ?></td>
													<td><?php echo $about->total_clients ?></td>
													<td><?php echo $about->complete_project ?></td>
													<td><?php echo $about->running_project ?></td>
													<td>
														<a href="<?php echo base_url('Dashboard/edit_about_info/' . $about->id) ?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
													</td>
												</tr>
											<?php } ?>
										</tbody>
