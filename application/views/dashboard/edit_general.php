    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Update website's general informations</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <form action="<?php echo base_url('Dashboard/update_general_info/' . $edit->id) ?>" method="post">
                    <table class=" table table-bordered">
                      <tr>
                        <th>Logo</th>
                        <td><input type="text" name="logo" class="form-control" value="<?php echo $edit->logo ?>"></td>
                        <th>Call us</th>
                        <td><input type="text" name="call_us" class="form-control" value="<?php echo $edit->call_us ?>"></td>
                        <th>Email us</th>
                        <td><input type="email" name="email_us" class="form-control" value="<?php echo $edit->email_us ?>"></td>
                      </tr>
                      <tr>
                        <th>Email</th>
                        <td><input type="email" name="email" class="form-control" value="<?php echo $edit->email ?>"></td>
                        <th>Office Address</th>
                        <td><input type="text" name="office_address" class="form-control" value="<?php echo $edit->office_address ?>"></td>
                        <th>Phone</th>
                        <td><input type="text" name="phone" class="form-control" value="<?php echo $edit->phone ?>"></td>
                      </tr>
                      <tr>
                        <th>Designed by</th>
                        <td><input type="text" name="designed_by" class="form-control" value="<?php echo $edit->designed_by ?>"></td>
                        <th>Footer News</th>
                        <td>
                          <textarea name="footer_news" id="footer_news" cols="30" rows="2"><?php echo $edit->footer_news ?></textarea>
                        </td>

                        <th>Description One</th>
                        <td><textarea name="top_description_one" id="top_description_one" cols="30" rows="2"><?php echo $edit->top_description_one ?></textarea></td>
                      </tr>
                      <tr>
                        <th>Description Tow</th>
                        <td><textarea name="top_description_tow" id="top_description_tow" cols="30" rows="2"><?php echo $edit->top_description_tow ?></textarea></td>

                        <th>Description Three</th>
                        <td><textarea name="top_description_three" id="top_description_three" cols="30" rows="2"><?php echo $edit->top_description_three ?></textarea></td>
